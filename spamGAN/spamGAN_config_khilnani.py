...
train_data = {#
    ...
    'datasets' : [ 
        {
            "files" : ['./data/khilnani_train_data.txt'],
            'vocab_file' : './data/khilnani_vocab.txt',
            'max_seq_length' : 128,
        ...
        {
            'files' : './data/khilnani_train_labels.txt',
            'data_type' : 'int',
            'data_name' : 'label'
        }
    ]
...
val_data = {
    ...
    'datasets' : [ 
        {
            "files" : ['./data/khilnani_val_data.txt'],
            'vocab_file' : './data/khilnani_vocab.txt',
            'max_seq_length' : 128,
            'length_filter_mode' : 'truncate',
            'bos_token' : '<BOS>',
        ...
        {
            'files' : ['./data/khilnani_val_labels.txt'],
            'data_type' : 'int',
            'data_name' : 'label'
        }
    ]
...
test_data = { 
    ...
    'datasets' : [ 
        {
            "files" : ['./data/khilnani_test_data.txt'],
            'vocab_file' : './data/khilnani_vocab.txt',
            'max_seq_length' : 128,
            'length_filter_mode' : 'truncate',
            'bos_token' : '<BOS>',
        ...
        {
            'files' : ['./data/khilnani_test_labels.txt'],
            'data_type' : 'int',
            'data_name' : 'label'
        }
    ]
